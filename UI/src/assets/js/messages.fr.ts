export const API_MESSAGES_FR: Record<string, string> = {
  ...
  AUTH_REFRESH_MISSING: "Session invalide. Reconnectez-vous.",
  AUTH_REFRESH_INVALID: "Session invalide. Reconnectez-vous.",
  AUTH_REFRESH_SUCCESS: "Session rafraîchie.",
  ...
  COACH_WEEK_PLAN_SERVICE_UNAVAILABLE:
    "Service coach indisponible. Vérifiez la configuration IA.",
  COACH_WEEK_PLAN_MISSING_PROGRESS:
    "Veuillez d'abord enregistrer vos informations avant de générer un programme.",
  COACH_WEEK_PLAN_MISSING_PREFS:
    "Veuillez renseigner vos préférences nutritionnelles avant de générer un programme.",
